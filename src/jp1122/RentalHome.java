...
public class RentalHome {
	...
	public static void main(String[] args) {
		System.out.println("Select Tool (CHSW, LADW, JAKD, JAKR): ");
	    ...
	    System.out.println(RentalAgreement.generateRentalAgreement(tool, rentalDays, discountRate, checkoutDate) );
	}
